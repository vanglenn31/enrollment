            ...
            <main class="flex-1 p-4 sm:p-6 lg:p-8">
                ...
                <div class="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm p-4 sm:p-6">
                    ...
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">
                                Add a new program under a department
                            </p>
                        </div>
                    ...
                    <form action="{{ route('admin.programs.store') }}" method="POST" class="space-y-5">
                        ...
                        <!-- CODE -->
                        <div>
                            <label class="text-sm font-medium text-gray-700">Program Code</label>
                        ...
                        <!-- NAME -->
                        <div>
                            <label class="text-sm font-medium text-gray-700">Program Name</label>
